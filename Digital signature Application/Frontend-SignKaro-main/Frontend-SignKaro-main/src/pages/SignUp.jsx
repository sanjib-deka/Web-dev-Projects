      ...
      <div className='flex justify-center items-center pt-28 pb-10 relative z-10'>
        ...
        >
          ...
          <form className='w-full flex flex-col items-center gap-5' onSubmit={handleSignup}>
            ...
            <button
              className="w-36 h-11 mt-2 rounded-md bg-gradient-to-r from-[#22c55e] to-[#14532d] text-white font-semibold shadow-lg hover:from-[#16a34a] hover:to-[#14532d] transition-all duration-200"
            >
              Register
            </button>
          </form>
